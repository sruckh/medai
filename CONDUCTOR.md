...
- **Tech Stack**: Python 3.11, FastAPI, SSE, HTTPX, Docker
- **Main File**: api/main.py (90 lines)
- **Core Mechanic**: Provider-switching SSE proxy for remote LLM chat
- **Key Integration**: Hugging Face TGI or RunPod vLLM inference endpoints
- **Platform Support**: VPS deployment with Docker
- **DO NOT**: Hardcode API keys, expose keys to frontend, use non-OpenAI compatible endpoints
